<%-- 
    Document   : HeaderAdminLog
    Created on : Sep 22, 2020, 10:24:48 PM
    Author     : user
--%>
                        ...
                        <div class="col-md-8 col-sm-12">
                            <div class="right-nav">
                                ...
                                <div class="nav-b hidden-xs">
                                    <div class="nav-box">
                                        <ul>
                                            <li><a href="CustomizeProduct.jsp">Customize Product</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="nav-b hidden-xs">
                                    <div class="nav-box">
                                        <ul>
                                            <li><a href="AddNewProducts.jsp">Add New Products</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="nav-b hidden-xs">
