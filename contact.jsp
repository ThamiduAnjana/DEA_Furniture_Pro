                        ...
                        <table>
                            <tr style="height:50px">  <td>Name:</td><td> <input type="text" name="name"  style="border-bottom: 1px solid gray;"/></td></tr>
                             <tr style="height:50px"><td> Email:</td><td> <input type="text" name="email" style="border-bottom: 1px solid gray;"/></td></tr>
                              <tr style="height:50px">  <td> Message:</td><tD> <input type="text" name="msg" style="border-bottom: 1px solid gray;"/> </td></tr>
                              <tr style="height:50px"> <td > <input type="submit" value="send" class="btn-primary" > </td> </tr> </table> <br><br>
                              <table>  <tr><td><i class="fa fa-map-marker"></i></td><td> No. 310, High Level Road, Nawinna, Maharagama, Sri Lanka.</td></tr> 
                            <tr><td >
<i class="fa fa-phone"></i></td><td>+94112803903 &nbsp;&nbsp;  | &nbsp;&nbsp; +94114310500 </td></tr>
